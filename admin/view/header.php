<!DOCTYPE html>
<!-- saved from url=(0078)https://colorlib.com/polygon/adminpro/adminpro/gradient-design/dashboard.html# -->
<html class="no-js mdl-js" lang="en">
...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon"
        href="https://colorlib.com/polygon/adminpro/adminpro/gradient-design/img/favicon.ico">
    ...
    <link rel="stylesheet" href="admin/ADMIN/font-awesome.min.css">

    <link rel="stylesheet" href="admin/ADMIN/adminpro-custon-icon.css">

    <link rel="stylesheet" href="admin/ADMIN/meanmenu.min.css">

    <link rel="stylesheet" href="admin/ADMIN/jquery.mCustomScrollbar.min.css">

    <link rel="stylesheet" href="admin/ADMIN/animate.css">

    <link rel="stylesheet" href="admin/ADMIN/bootstrap-table.css">
    <link rel="stylesheet" href="admin/ADMIN/bootstrap-editable.css">

    <link rel="stylesheet" href="admin/ADMIN/normalize.css">

    <link rel="stylesheet" href="admin/ADMIN/c3.min.css">

    <link rel="stylesheet" href="admin/ADMIN/all-type-forms.css">
    ...
    <script type="text/javascript" async="" src="admin/ADMIN/analytics.js.tải xuống"
        nonce="9372192a-2f08-4341-8013-f01cc6f29c3f"></script>
    <script defer="" referrerpolicy="origin" src="admin/ADMIN/s.js.tải xuống"></script>
    <script src="admin/ADMIN/modernizr-2.8.3.min.js.tải xuống"></script>
    <meta name="robots" content="noindex, nofollow">
    <script nonce="9372192a-2f08-4341-8013-f01cc6f29c3f">
    (function(w, d) {
        ! function(a, e, t, r) {
    ...
    <script type="text/javascript" src="chrome-extension://aggiiclaiamajehmlfpkjmlbadmkledi/tat_popup.js" async="">
    </script>
    <style>
    .ejoy-sub-active {
            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item"><a href="admin.php?act=tintuc" data-toggle="dropdown" role="button"
                                aria-expanded="false" class="nav-link dropdown-toggle"><i class=""><img
                        ...
                        <li class="nav-item"><a href="admin.php?act=addbl" data-toggle="dropdown" role="button"
                                aria-expanded="false" class="nav-link dropdown-toggle"><i class=""><img
                        ...
                        <li class="nav-item"><a href="admin.php?act=khachhang" data-toggle="dropdown" role="button"
                                aria-expanded="false" class="nav-link dropdown-toggle"><i class=""><img
                                        src="https://cdn-icons-png.flaticon.com/128/8848/8848642.png" alt=""
                                        style="width:15px; height:15px;"></i> <span class="mini-dn">User</span>
                            </a>
                            <div role="menu"
                                class="dropdown-menu left-menu-dropdown pages-left-menu-std animated flipInX">
                                <a href="https://colorlib.com/polygon/adminpro/adminpro/gradient-design/login.html"
                        ...
                        <li class="nav-item"><a href="admin.php?act=donhang" data-toggle="dropdown" role="button"
                                aria-expanded="false" class="nav-link dropdown-toggle"><i class=""><img
                                        src="https://cdn-icons-png.flaticon.com/128/8848/8848642.png" alt=""
                                        style="width:15px; height:15px;"></i> <span class="mini-dn">Quản Lý Đơn Hàng</span>
                            </a>
                            <div role="menu"
                                class="dropdown-menu left-menu-dropdown pages-left-menu-std animated flipInX">
                                <a href="https://colorlib.com/polygon/adminpro/adminpro/gradient-design/login.html"
                                ...
                                <div class="header-top-menu tabl-d-n">
                                    <ul class="nav navbar-nav mai-top-nav">
                                        ...
                                        <li class="nav-item dropdown">
                                            <a href="admin.php?act=tintuc" data-toggle="dropdown" role="button"
                                                aria-expanded="false" class="nav-link dropdown-toggle">Tin Tức </a>
                                        ...
                                        <li class="nav-item"><a href="admin.php?act=addbl" class="nav-link">Bình
                                                Luận</a>
                                        </li>
                                        <li class="nav-item"><a href="admin.php?act=qluser" class="nav-link"> User
                                            </a>
                                        </li>
                                        <li class="nav-item"><a href="admin.php?act=quanlydonhang" class="nav-link">Quản Lý
                                                Đơn Hàng
                                            </a>
                                        </li>
                                    </ul>
