...
<div class="row">
    ...
    <form action="admin.php?act=addloai" method="post">
            ...
            <div class="col-sm-12">
                <form action="admin.php?act=add_post" method="post" enctype="multipart/form-data">
                    <div class="card-box" style="margin-top:15px;">
                        ...
                        <input type="text" class="form-control" id="" name="tenloai" placeholder="Thêm loại" required>
                    </div>
            </div>
        </div>
            ...
            <div class="col-sm-12">
                <form action="admin.php?act=add_post" method="post" enctype="multipart/form-data">
                    <div class="card-box" style="margin-top:15px;">
                        ...
                        <div class="dv">
                      <input type="radio" class="form-control" id="" name="tenloai" placeholder="Ẩn hiện loại"
                                 checked>Ẩn
                         <input type="radio" class="form-control" id="" name="tenloai" placeholder="Ẩn hiện loại"
                                checked>Hiện                       
                        </div>
