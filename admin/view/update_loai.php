...
<div class="row">
    ...
    <form action="admin.php?act=update_loai" method="post">
        <div class="row formcontent">
                    ...
                    <div class="col-sm-12">
                        <form action="admin.php?act=add_post" method="post" enctype="multipart/form-data">
                            <div class="card-box" style="margin-top:15px;">
                                <h4 class="m-b-30 m-t-0 header-title"> <b>TÊN LOẠI</b> </h4>
                                <input type="text" class="form-control" id="" name="tenloai" placeholder=""
                                    required value="<?=$kq1[0]['tenloai']?>">
                            </div>
                    </div>
                </div>
            ...
            <div class="row mb1">
                <input type="submit" value="Cập Nhật" name="capnhat" class="btn btn-success waves-effect waves-light">
            </div>
        </div>
    </form>
    <div class="row formcontent">
        ...
        <div class="row mb1">
            <a href="admin.php?act=addloai"> <input type="button" value="Thêm Mới" name="themmoi"
                    class="btn btn-success waves-effect waves-light"></a>
            <a href="admin.php?act=dsloai"> <input type="button" value="Danh Sách"
                    class="btn btn-danger waves-effect waves-light"></a>
        </div>
