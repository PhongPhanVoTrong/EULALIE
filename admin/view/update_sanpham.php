                    ...
                    <div class="col-sm-12">
                        <form action="admin.php?act=add_post" method="post" enctype="multipart/form-data">
                            <div class="card-box" style="margin-top:15px;">
                                ...
                                <input type="text" class="form-control" id="" name="tensp" placeholder="Thêm sản phẩm" value="<?=$kq1[0]['tensp']?>"
                                    required>
                            </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <form action="admin.php?act=add_post" method="post" enctype="multipart/form-data">
                            <div class="card-box" style="margin-top:15px;">
                                ...
                                <input type="text" class="form-control" id="" name="gia" placeholder="Thêm giá sản phẩm" value="<?=$kq1[0]['dongia']?>"
                                    required>
                            </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <form action="admin.php?act=add_post" method="post" enctype="multipart/form-data">
                            <div class="card-box" style="margin-top:15px;">
                                ...
                                <input type="text" class="form-control" id="" name="slx" placeholder="Thêm số lượt xem" value="<?=$kq1[0]['soluotxem']?>"
                                    required>
                            </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <form action="admin.php?act=add_post" method="post" enctype="multipart/form-data">
                            <div class="card-box" style="margin-top:15px;">
                                ...
                                <input type="text" class="form-control" id="" name="tt" placeholder="Thêm mô tả" value="<?=$kq1[0]['mota']?>"
                                    required>
                            </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-12">
                        <form action="admin.php?act=add_post" method="post" enctype="multipart/form-data">
                            <div class="card-box" style="margin-top:15px;">
                                ...
                                <div class="dv">
                                    <input type="radio" class="form-control" id="" name="role" value="<?=$kq1[0]['anhien']?>"
                            ...
                            <div class="row mb1">
                                <input type="submit" value="Cập Nhật" name="capnhat" class="btn btn-danger waves-effect waves-light">
                            </div>
                        </div>
                    </form>
                    <div class="row formcontent">
                        ...
                        <div class="row mb1">
                            <a href="admin.php?act=addsanpham"> <input type="button" value="Thêm Mới"
                                    name="themmoi" class="btn btn-success waves-effect waves-light"></a>
                        </div>
